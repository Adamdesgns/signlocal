...
typography:
  ...
  title-card-sm:{ fontFamily: "Inter", cqw: 2.9, weight: 400, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Inter", cqw: 3.5, weight: 400, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Inter", cqw: 4.4, weight: 400, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Inter", cqw: 5.0, weight: 400, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Inter", cqw: 7.3, weight: 400, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Inter", cqw: 11.5, weight: 400, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Inter", cqw: 11.5, weight: 400, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Inter", cqw: 5.7, weight: 400, lineHeight: 0.92 }
  name:    { fontFamily: "Inter", cqw: 2.3, weight: 700, lineHeight: 1.0 }
...
- **Weights** — the brand font ships `{400, 700, 750, 850, 950}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
